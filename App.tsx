        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
          <Card className="glass-card max-w-sm w-full text-center p-8 space-y-6">
            ...
            <p className="text-slate-400 text-sm italic">
              O barbeiro analisará seu pedido e entrará em contato via WhatsApp
              em breve.
            </p>
            <Button
        ...
        <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="flex justify-between items-start">
            <div className="flex-1 text-center sm:text-left space-y-2">
              ...
              <p className="text-elite-cyan-400 text-[10px] font-black uppercase tracking-[0.2em] italic">
                Agendamento Online
              </p>
            </div>
            <button
            ...
            <div className="space-y-6">
              <Card className="glass-card p-6 space-y-4">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <Button onClick={fetchMyBookings} className="h-12 px-6">
                    VER
                  </Button>
                </div>
              </Card>
              ...
              <div className="space-y-3">
                {myRequests.map((r) => (
                  <div
                    key={r.id}
                    className="p-4 bg-slate-900/50 rounded-2xl border border-white/5 flex items-center justify-between"
                  >
                    <div>
                      <p className="text-[10px] text-slate-500 font-bold uppercase">
                        {r.date.split("-").reverse().join("/")} • {r.time}
                      </p>
                      <p className="text-white font-black italic uppercase italic text-xs">
            ...
            <form onSubmit={handleSubmitRequest} className="space-y-6">
                    ...
                    {bookingServices.length === 0 ? (
                      <div className="text-center py-8 space-y-3">
                        ...
                        <p className="text-slate-500 font-bold uppercase tracking-widest text-[10px] leading-relaxed max-w-[200px] mx-auto">
                          Este barbeiro ainda não cadastrou serviços para
                          agendamento online.
                        </p>
                      </div>
                    ) : (
                      bookingServices.map((s) => (
                        ...
                        >
                          ...
                          <p className="font-black text-elite-cyan-400 italic">
                            R$ {s.price.toFixed(2)}
                          </p>
                        </button>
                      ))
              ...
              {step === 2 && (
                <Card className="glass-card p-6 space-y-6">
                  <button
                    onClick={() => setStep(1)}
                    className="text-[10px] font-black text-slate-500 uppercase flex items-center gap-1 hover:text-white transition-colors"
                  >
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-6">
                      ...
                      {bookingDate && (
                        <div className="space-y-3">
                          <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest px-1 italic">
                            Horários livres em{" "}
                ...
                <Card className="glass-card p-6 space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-elite-cyan-500/5 rounded-2xl border border-white/5 mb-4">
                      <p className="text-[9px] font-black text-elite-cyan-400 uppercase tracking-widest mb-1 italic">
                        Resumo do Pedido
                      </p>
                      <p className="text-xs font-bold text-white uppercase italic">
                        {selectedService?.name} •{" "}
                        {bookingDate.split("-").reverse().join("/")} às{" "}
                        {bookingTime}
                      </p>
                    </div>
                    <Input
                  ...
                  <Button
                    ...
                    className="w-full py-5 text-sm tracking-[0.2em] font-black italic"
                  >
